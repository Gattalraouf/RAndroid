...
public class HSSRefactoringUtility extends IRefactor {
    ...
    private void RunServiceOnBackground(MethodObject onStartCommand, ClassObject c, Project myProject) {
        ...
        PsiUtils.addImport(elementFactory, psiFile, "android.os");
        ...
        WriteCommandAction.runWriteCommandAction(myProject, () -> {
            ...
            PsiElement elem = psiFile.addAfter(type, onStartCommand.getMethodDeclaration().getBody().getFirstBodyElement());
